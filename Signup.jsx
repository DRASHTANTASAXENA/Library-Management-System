...
export default function Signup() {
  ...
  const handleSignup = async (e) => {
    ...
    setError("");
    try {
      await axios.post("http://127.0.0.1:8000/signup", { name, email, password, role });
      navigate("/login"); // Updated path to match our App.jsx route
    } catch (err) {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-[#0f172a] overflow-hidden">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[45%] h-[45%] bg-blue-600/20 rounded-full blur-[120px]"></div>
      <div className="absolute bottom-[-10%] left-[-10%] w-[45%] h-[45%] bg-indigo-600/20 rounded-full blur-[120px]"></div>
        ...
        <div className="bg-white/80 backdrop-blur-2xl p-10 rounded-[3rem] shadow-2xl border border-white/20 animate-fade-in-up">
          ...
          <div className="text-center mb-8">
            <h1 className="text-4xl font-black text-gray-900 tracking-tighter uppercase">
              Join the <span className="text-blue-600">System</span>
            </h1>
            <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mt-2">
              Create your unified library account
            </p>
          </div>
